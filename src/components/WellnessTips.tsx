...
const tipCategories: TipCategory[] = [
  ...
  },
  {
    ...
    emoji: "✨",
    tips: [
      { title: "Conexão Interior", description: "Reserve tempo para reflexão pessoal e autoconhecimento diário.", icon: <Sparkles className="w-4 h-4" /> },
      { title: "Propósito de Vida", description: "Defina seus valores e objetivos. O que realmente importa para você?", icon: <Heart className="w-4 h-4" /> },
      { title: "Natureza", description: "Passe tempo ao ar livre. A natureza tem poder curativo comprovado.", icon: <Wind className="w-4 h-4" /> },
      { title: "Práticas Contemplativas", description: "Oração, yoga ou tai chi conectam corpo, mente e espírito.", icon: <Sparkles className="w-4 h-4" /> },
      { title: "Perdão", description: "Perdoe a si mesmo e aos outros. O ressentimento pesa na recuperação.", icon: <Heart className="w-4 h-4" /> },
      { title: "Comunidade Espiritual", description: "Grupos de fé ou meditação oferecem apoio e pertencimento.", icon: <Users className="w-4 h-4" /> },
    ],
  },
  {
    id: "social",
